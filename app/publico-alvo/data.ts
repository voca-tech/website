...
export const personas: Persona[] = [
    {
        ...
        features: ["Indicadores e Relatórios", "Análise de Turnover", "Pesquisas Customizadas"],
    ...
    },
    {
        ...
        features: ["Avaliação de Desempenho", "Feedback", "Plano de Desenvolvimento Individual"],
