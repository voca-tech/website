    ...
    return (
        <div className="bg-gradient-to-b from-voca-green to-voca-green/70 items-center py-14 px-6">
            <div className='grid grid-cols-1 lg:grid-cols-8 gap-20 items-center justify-between font-light max-w-7xl  m-auto'>
                <div className='flex flex-col items-center lg:items-start text-center lg:text-start gap-8 lg:col-span-5'>
                    <h1 className="text-4xl sm:text-5xl text-white font-bold">
                        DHO na palma da mão
                    </h1>

                    <h1 className="text-3xl sm:text-3xl tracking-tight text-slate-100 ">
                        Plataforma de{' '}
                        <span className="relative whitespace-nowrap text-teal-200">
                            <svg
                                aria-hidden="true"
                                viewBox="0 0 418 42"
                                className="absolute top-2/3 left-0 h-[0.58em] w-full fill-white/30"
                    ...
                    <p className="text-xl sm:text-lg text-md tracking-tight text-white/60">
                ...
                <div className='items-center lg:col-span-3 w-full md:w-3/4 lg:w-full mx-auto'>
                    <ContactForm />
                </div>
            </div>
        </div>
