...
export const quotes: Quote[] = [
    ...
    { name: 'Walter Rodrigues', role: 'Diretor de RH', company: 'Grant Thornton', logo: '/clients/grantthornton.png', text: 'O VOCA está sempre em evolução, combinando funcionalidades de DHO e comunicação interna na mesma plataforma, o que facilita muito para trabalhar o engajamento do time de forma contínua.', caseSlug: 'grant-thornton' },
